...
const q5_old = `        <div class="question-card" data-qid="listen-m1-5">
...
const q5_new = `        <div class="question-card" data-qid="listen-m1-5">
          ...
          <div class="explanation" data-explain=""></div>
        </div>`;
html = html.replace(q5_old, q5_new);

const q6_old = `        <div class="question-card" data-qid="listen-m1-6">
...
const q6_new = `        <div class="question-card" data-qid="listen-m1-6">
...
const m2q5_old = `        <div class="question-card" data-qid="listen-m2-5">
...
const m2q5_new = `        <div class="question-card" data-qid="listen-m2-5">
...
const explanations = {
    ...
    "listen-m2-4": "【Script】<br>女「林さんの家は山と海は近いから、毎日見ていますよ。この橋の絵のはがきはどうですか。綺麗ですよ。」<br>男「いいですね。それを出しましょう。」<br><br>【Giải thích】Cả hai chọn thiệp có hình cây cầu (橋の絵) để gửi vì nhà bạn kia đã gần núi và biển. Chọn đáp án 4 (Ảnh số 4 là cây cầu).",
    ...
    "listen-m2-6": "【Script】<br>男「僕はスポーツが大好きです。授業の前に毎朝友達とバスケットボールの練習をしています。時々大学のプールで泳いだり、テニスをしたりしています。サッカーはあまりしませんが、毎日見ています。」<br><br>【Giải thích】Mỗi sáng trước giờ học tập bóng rổ (バスケットボールの練習をしています). Chọn đáp án 1 (Ảnh 1 là bóng rổ).",
...
for (const [qid, exp] of Object.entries(explanations)) {
    const exp_clean = exp.replace(/"/g, '&quot;');
    const pattern = new RegExp(`(<div class="question-card" data-qid="${qid}">[\\s\\S]*?<div class="explanation".*?data-explain=")(.*?)("></div>)`);
    html = html.replace(pattern, `$1${exp_clean}$3`);
}

fs.writeFileSync('index.html', html, 'utf8');
console.log('Updated index.html successfully.');

// UPDATE APP.JS ANSWERS
let appjs = fs.readFileSync('app.js', 'utf8');

const keyUpdates = {
    "'listen-m1-6': '3'": "'listen-m1-6': '2'",
    "'listen-m2-4': '3'": "'listen-m2-4': '4'",
    "'listen-m2-6': '2'": "'listen-m2-6': '1'",
    "'listen-m3-1': '2'": "'listen-m3-1': '1'",
    "'listen-m3-2': '1'": "'listen-m3-2': '2'",
    "'listen-m3-3': '3'": "'listen-m3-3': '2'",
    "'listen-m3-4': '2'": "'listen-m3-4': '3'",
    "'listen-m3-5': '1'": "'listen-m3-5': '2'",
    "'listen-m4-2': '1'": "'listen-m4-2': '2'",
    "'listen-m4-4': '1'": "'listen-m4-4': '3'",
    "'listen-m4-5': '3'": "'listen-m4-5': '1'",
    "'listen-m4-6': '2'": "'listen-m4-6': '3'",
};

for (const [oldKey, newKey] of Object.entries(keyUpdates)) {
    appjs = appjs.replace(oldKey, newKey);
}
